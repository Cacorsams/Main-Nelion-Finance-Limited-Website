...
const EndelezaFeature = () => {
    const usages = [
        { icon: "mdi:store", title: "Business Expansion", desc: "Capital to scale your reach" },
        { icon: "mdi:cart-plus", title: "Stock & Equipment", desc: "Inventory and tools" },
        { icon: "mdi:school", title: "School Fees", desc: "Investing in education" },
        { icon: "mdi:medical-bag", title: "Medical Expenses", desc: "Health security focus" },
    ];
                ...
                <div className="grid lg:grid-cols-12 gap-16 items-center">
                    ...
                    <div className="lg:col-span-6 relative" data-aos="fade-right">
                        ...
                        <div className="absolute top-10 right-0 p-6 bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl animate-pulse hidden md:block">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm font-black uppercase tracking-widest text-midnight_text dark:text-white">Fast Access</span>
                            </div>
                        </div>
                        <div className="absolute bottom-10 -left-10 p-6 bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl hidden md:block">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm font-black uppercase tracking-widest text-midnight_text dark:text-white">Community Impact</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-6 space-y-10" data-aos="fade-left">
                        <div className="space-y-6">
                            <h2 className="text-xs uppercase font-black text-primary tracking-[0.3em] ml-2">Flagship Product</h2>
                            <h3 className="text-6xl md:text-7xl font-black text-midnight_text dark:text-white uppercase tracking-tighter leading-none italic">
                                Endeleza <span className="text-primary">Loan</span>
                            </h3>
                            <p className="text-xl text-gray dark:text-gray-400 font-medium leading-relaxed">
                                <span className="text-primary font-black italic">"Endeleza"</span> means to develop or move forward. This loan is a catalyst for traders, entrepreneurs, and employees across Tanzania.
                            </p>
                        </div>
